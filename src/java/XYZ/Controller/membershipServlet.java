...
public class membershipServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String username = "";//need to get username from session
            stmt = conn.createStatement();
            String sql_query = "SELECT membership_status, membership_expiry_date from users where username =" + username;
            ResultSet rs = stmt.executeQuery(sql_query);  
            
             membershipStatus = rs.getString("membership_status");
             expiryDate = rs.getString("membership_expiry_date");
