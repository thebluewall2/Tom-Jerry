...
public class AdminViewClaimServlet extends HttpServlet {
...
//        }
             ...
             request.getRequestDispatcher("/view/AdminViewAllClaim.jsp").forward(request, response); // put to userhome to test whether list can be added
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AdminViewClaimServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
